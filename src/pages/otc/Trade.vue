<template>
    <div class="nav-right tradeCenter">
        <section class="trade-group merchant-top">
            ...
            <span class="tips-word">{{$t('otc.adCenter')}}</span>
            <a href="/#/identbusiness">{{$t('otc.identbusiness')}}&gt;&gt;</a>
        </section>
        <section class="list-content">
            <Tabs :value="tabPage">
                <TabPane :label="$t('common.ibuy')" name="buy">
                     <!--列表表格-->
                ...
                <TabPane :label="$t('common.isell')" name="sell">
                   <div class="table-responsive list-table">
    ...
    data() {
        ...
        return {
            ...
            advertiment:{
                ...
                columns:[
                    {
                        title: this.$t('common.memberName'),
                        key: 'memberName',
                        width: 250,
                        ellipsis: true,
                    ...
                    {
                        title: this.$t('otc.transactions'),
                        key: 'transactions',
                    },
                    {
                        title: this.$t('otc.payMode'),
                        key: 'payMode',
                    },
                    {
                            ...
                            return h('p', [
                                h('a', {
                                    ...
                                    on: {
                                        ...
                                        }, params.row.advertiseType == 0 ?self.$t('common.sell'):self.$t('common.buy'))
                                    ]),
                            ]);
                        }
                    }
