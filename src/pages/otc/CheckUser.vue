                    ...
                    <div class="leftmenu left-box">
                        ...
                        <div class="deal-market-info">
                            ...
                            <p v-else>
                                ...
                                <span class="unmarket">{{$t('otc.idCardAuthorized')}}</span>
                            </p>
                        </div>
                    ...
                    <div class="right-safe">
                        <div class="trade-right-box">
                            <div class="trade-price">
                                <Row class="tit">
                                    <Col span="6">{{$t('otc.language')}}</Col>
                                    <Col span="6">{{$t('otc.registerTime')}} {{user.createTime}}</Col>
                                    <Col span="6">{{$t('otc.totalTransactions')}} {{user.transactions}}</Col>
                                </Row>
                            </div>
                        </div>
                        <div class="trade-operation">
                            <div class="trade-group merchant-top">
                                ...
                                <span class="tips-word">{{user.username}}{{$t('otc.tradeInformation')}}</span>
                            </div>
                        </div>
                        <div class="demo-tabs-style1 tabbox">
                            <Tabs value="name1">
                                <TabPane :label="$t('otc.onlineSale')" name="name1">
                                ...
                                <TabPane :label="$t('otc.onlinePurchase')" name="name2">
                                    <div class="order-table">
...
export default {
    ...
    computed: {
        ...
        tableColumnsOrderSell() {
            ...
            columns.push({
                title: self.$t('otc.publishTime'),
                key: 'createTime',
                width: 160,
            });
            columns.push({
                title: self.$t('common.modify'),
                key: 'buyBtn',
                render: function(h, params) {
                    return h('p', [
                        h('a', {
                            on: {
                                click: function() {
                                    if (!self.isLogin) {
                                        ...
                                        self.$Message.error(self.$t('uc.realRule'));
                                        setTimeout(() => {
