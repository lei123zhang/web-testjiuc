                    ...
                    <div class="table-inner action-box open">
                        <div class="action-inner">
                            ...
                            <div class="inner-box deposit-address mt25">
                                ...
                                <div class="title">
                                    <Input v-model="withdrawAddr" style="width: 90%;margin-top:10px;" size="large"/>
                                </div>
                            </div>
                            <div class="mt25">
                                <p class="describe">{{$t('common.remark')}}</p>
                                <div class="title">
                                    <Input v-model="remark" style="width:100%;margin-top:10px;" size="large"/>
                                </div>
                            </div>
                        </div>
                        <div class="btnbox">
            ...
            <div style="text-align:center">
                <Form ref="formValidateAddr" :model="formValidateAddr" :rules="ruleValidate" :label-width="85">
                    ...
                    <FormItem :label="$t('common.email')" prop="email" v-show="validEmail">
                        <Input disabled v-model="formValidateAddr.email" size="large"/>
                    </FormItem>
                    <!-- 邮箱验证码 -->
